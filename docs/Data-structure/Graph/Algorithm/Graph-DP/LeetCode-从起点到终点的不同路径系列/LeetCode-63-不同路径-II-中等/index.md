...
在 leetcode [62. 不同路径](https://leetcode-cn.com/problems/unique-paths/) 的基础上增加了一点难度：增加了障碍物，对 leetcode [62. 不同路径](https://leetcode-cn.com/problems/unique-paths/) 做一点修改即可解决这道题。
